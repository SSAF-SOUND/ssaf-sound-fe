...
import {
  ...
  mockGetAppliedRecruitsByOffsetError,
  mockGetEmptyAppliedRecruitsByOffset,
} from '~/mocks/handlers/recruit/apis/mockGetAppliedRecruitsByOffset';
...
const meta: Meta<typeof AppliedRecruitsPage> = {
  ...
  parameters: {
    ...
    ...createMswParameters({
      ...
      recruit: [mockGetAppliedRecruitsByOffset],
    }),
  },
...
export const Project__Empty: AppliedRecruitsPageStory = {
  ...
  parameters: {
    ...createMswParameters({
      recruit: [mockGetEmptyAppliedRecruitsByOffset],
    }),
  },
};
...
export const Error: AppliedRecruitsPageStory = {
  ...
  parameters: {
    ...createMswParameters({
      recruit: [mockGetAppliedRecruitsByOffsetError],
    }),
  },
};
